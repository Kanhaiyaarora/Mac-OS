...
const Dock = ({ windowsState, setWindowsState }) => {
  return (
    <footer className='dock'>
      ...
      <div onClick={() => window.open("https://www.linkedin.com/in/kanhaiya-arora/", "_blank")} className="icon link"><img src="/doc-icons/link.svg" alt="" /></div>
      <div onClick={() => { setWindowsState(state => ({ ...state, cli: true })) }} className="icon cli"><img src="/doc-icons/cli.svg" alt="" /></div>
    </footer>
  )
}
